...
const sections = {
  A: {
    label: "pronomen",
    words: ["Han", "Hon", "Den", "Det", "De"]
  },
  B: {
    label: "verb",
    words: ["springer", "knarkar", "cyklar", "biter", "letar"]
  },
  C: {
    label: "räkneord",
  ...
  D: {
    label: "adjektiv",
    words: ["blåa", "stor", "tyst", "glatt", "noggrant"]
  },
  E: {
    label: "konjunktion",
    words: ["och", "eller", "men", "i"]
  },
  F: {
    label: "adjektiv",
    words: ["små", "roligt", "varmt", "rund", "noggrant"]
  },
  G: {
    label: "substantiv",
